...
The app simply fetches a page from a url, parses the contents and exits. To generate telemetry, the app container is defined in the [docker-compose.yaml](docker-compose.yaml) to restart indifinitely (restart: always).
