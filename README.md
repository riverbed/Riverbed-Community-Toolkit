...
| [233](233-instrument-java-app-with-apm-agentless-on-gke) | Containerize an applicaion with the APM Agentless for Java and deploy it on Google Kubernetes Engine | [ALLUVIO Aternity APM](https://www.riverbed.com/products/application-performance-monitoring) | APM Agentless for Java, APM Java agent for Linux, Java, APM host-agentless, Web App, Google Cloud, Kubernetes, GKE, auto-instrumentation | jan. 2023 |
