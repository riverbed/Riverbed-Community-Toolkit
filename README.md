...
| [Windows](/Windows) | Library Remediations scripts for Windows End Point (including script to interact with Riverbed Client Accelerator agent (a.k.a SteelHead Mobile), Application Signatures [Aternity](https://www.aternity.com/) | Azure, Windows, PowerShell  |
