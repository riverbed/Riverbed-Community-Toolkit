...
**Note**:- By default the SteelHead appliance will be deployed in AWS region - ap-south-1. You can copy below url and change the region parameter accordingly in the URL. In below URL change **region=ap-south-1** with your region.
```PowerShell
...
Follow [SH-101 README](./101-service-chain-gw-appliance.md) steps to deploy acceleration in a VPC created in Step 1.
