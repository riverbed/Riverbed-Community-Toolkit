param(
  ...
  # Set default url to fetch specific azcopy version
  ## get latest: curl -s -D- https://aka.ms/downloadazcopy-v10-linux | grep ^Location
  ## 10.10.0: sporadic issue fatal error lifecyleMgr.go:38 (https://azcopyvnext.azureedge.net/release20210415/azcopy_linux_amd64_10.10.0.tar.gz)
  ## 10.9.0: sporadic issue https://azcopyvnext.azureedge.net/release20210226/azcopy_linux_amd64_10.9.0.tar.gz
